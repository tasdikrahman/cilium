...
// RandomRune returns a random name string with fixed prefix
func RandomRuneWithPrefix(prefix string, n int) string {
	return prefix + RandomRuneWithLen(n)
}

// RandomRune returns a random name
...
// RandomRune returns a random name witha  predefined length of 12
